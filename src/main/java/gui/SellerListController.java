...
public class SellerListController implements Initializable, DataChangeListener {
	...
	@FXML
	private TableColumn<Seller, Date> tableColumnDataBrity;
	@FXML
	...
	public void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		try {
			...
			dialogStage.setTitle("Enter Seller dada");
	...
	private void initializeNodes() {
		...
		tableColumnDataBrity.setCellValueFactory(new PropertyValueFactory<>("birthDate"));
		Utils.formatTableColumnDate(tableColumnDataBrity, "dd/MM/yyyy");
	...
	private void removeEntity(Seller obj) {
		...
		if(result.get() == ButtonType.OK) {
			...
			try {
				...
				System.out.println("N o 0 0 0 0 0 0 0 0- - - - - -");
